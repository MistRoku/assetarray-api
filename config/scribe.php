...
return [
    ...
    'intro_text' => <<<'INTRO'
            AssetArray API — multi-branch inventory management. Grab a token via `POST /api/v1/auth/login`
    ...
    'auth' => [
        // Most endpoints require a Sanctum bearer token (see auth.default).
        'enabled' => true,

        // Authenticated by default; the three public auth endpoints
        // (login, forgot/reset password) carry @unauthenticated instead.
        'default' => true,
        ...
        'extra_info' => 'Grab a token via <b>POST /api/v1/auth/login</b> (demo: manager@assetarray.test / password). Deactivated accounts get <b>403</b> on every call.',
    ],
